...
## Project Structure
* [`main.cpp`](./main.cpp) — The C++ engine that calculates position and velocity over time using RK4 and outputs data.
* [`plot-data.py`](./plot-data.py) — Python script that reads the CSV and generates the visual plot.
* [`trajectory.csv`](./trajectory.csv) — Output dataset containing raw spatial telemetry.
* [`trajectory.png`](./trajectory.png) — Rendered trajectory graph.

## Trajectory Plot
Here is the output graph generated by the Python script:
